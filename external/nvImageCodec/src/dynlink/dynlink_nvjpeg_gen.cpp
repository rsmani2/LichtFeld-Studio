...
nvjpegStatus_t nvjpegGetProperty(libraryPropertyType type, int * value) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetProperty")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetProperty")) :
                           nvjpegGetPropertyNotFound;
...
nvjpegStatus_t nvjpegCreate(nvjpegBackend_t backend, nvjpegDevAllocator_t * dev_allocator, nvjpegHandle_t * handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreate")) :
                           nvjpegCreateNotFound;
...
nvjpegStatus_t nvjpegCreateSimple(nvjpegHandle_t * handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateSimple")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateSimple")) :
                           nvjpegCreateSimpleNotFound;
...
nvjpegStatus_t nvjpegCreateEx(nvjpegBackend_t backend, nvjpegDevAllocator_t * dev_allocator, nvjpegPinnedAllocator_t * pinned_allocator, unsigned int flags, nvjpegHandle_t * handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateEx")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateEx")) :
                           nvjpegCreateExNotFound;
...
nvjpegStatus_t nvjpegCreateExV2(nvjpegBackend_t backend, nvjpegDevAllocatorV2_t * dev_allocator, nvjpegPinnedAllocatorV2_t * pinned_allocator, unsigned int flags, nvjpegHandle_t * handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateExV2")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegCreateExV2")) :
                           nvjpegCreateExV2NotFound;
  return func_ptr(backend, dev_allocator, pinned_allocator, flags, handle);
}
...
nvjpegStatus_t nvjpegDestroy(nvjpegHandle_t handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDestroy")) :
                           nvjpegDestroyNotFound;
  return func_ptr(handle);
}
...
nvjpegStatus_t nvjpegSetDeviceMemoryPadding(size_t padding, nvjpegHandle_t handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegSetDeviceMemoryPadding")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegSetDeviceMemoryPadding")) :
                           nvjpegSetDeviceMemoryPaddingNotFound;
...
nvjpegStatus_t nvjpegSetPinnedMemoryPadding(size_t padding, nvjpegHandle_t handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegSetPinnedMemoryPadding")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegSetPinnedMemoryPadding")) :
                           nvjpegSetPinnedMemoryPaddingNotFound;
  return func_ptr(padding, handle);
}
...
nvjpegStatus_t nvjpegGetHardwareDecoderInfo(nvjpegHandle_t handle, unsigned int * num_engines, unsigned int * num_cores_per_engine) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetHardwareDecoderInfo")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetHardwareDecoderInfo")) :
                           nvjpegGetHardwareDecoderInfoNotFound;
...
nvjpegStatus_t nvjpegJpegStateCreate(nvjpegHandle_t handle, nvjpegJpegState_t * jpeg_handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStateCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStateCreate")) :
                           nvjpegJpegStateCreateNotFound;
...
nvjpegStatus_t nvjpegJpegStateDestroy(nvjpegJpegState_t jpeg_handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStateDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStateDestroy")) :
                           nvjpegJpegStateDestroyNotFound;
...
nvjpegStatus_t nvjpegGetImageInfo(nvjpegHandle_t handle, const unsigned char * data, size_t length, int * nComponents, nvjpegChromaSubsampling_t * subsampling, int * widths, int * heights) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetImageInfo")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegGetImageInfo")) :
                           nvjpegGetImageInfoNotFound;
...
nvjpegStatus_t nvjpegDecodeBatchedInitialize(nvjpegHandle_t handle, nvjpegJpegState_t jpeg_handle, int batch_size, int max_cpu_threads, nvjpegOutputFormat_t output_format) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedInitialize")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedInitialize")) :
                           nvjpegDecodeBatchedInitializeNotFound;
...
nvjpegStatus_t nvjpegDecodeBatched(nvjpegHandle_t handle, nvjpegJpegState_t jpeg_handle, const unsigned char *const * data, const size_t * lengths, nvjpegImage_t * destinations, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatched")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatched")) :
                           nvjpegDecodeBatchedNotFound;
...
nvjpegStatus_t nvjpegDecodeBatchedPreAllocate(nvjpegHandle_t handle, nvjpegJpegState_t jpeg_handle, int batch_size, int width, int height, nvjpegChromaSubsampling_t chroma_subsampling, nvjpegOutputFormat_t output_format) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedPreAllocate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedPreAllocate")) :
                           nvjpegDecodeBatchedPreAllocateNotFound;
...
nvjpegStatus_t nvjpegEncoderStateCreate(nvjpegHandle_t handle, nvjpegEncoderState_t * encoder_state, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderStateCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderStateCreate")) :
                           nvjpegEncoderStateCreateNotFound;
...
nvjpegStatus_t nvjpegEncoderStateDestroy(nvjpegEncoderState_t encoder_state) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderStateDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderStateDestroy")) :
                           nvjpegEncoderStateDestroyNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsCreate(nvjpegHandle_t handle, nvjpegEncoderParams_t * encoder_params, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsCreate")) :
                           nvjpegEncoderParamsCreateNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsDestroy(nvjpegEncoderParams_t encoder_params) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsDestroy")) :
                           nvjpegEncoderParamsDestroyNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsSetQuality(nvjpegEncoderParams_t encoder_params, const int quality, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetQuality")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetQuality")) :
                           nvjpegEncoderParamsSetQualityNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsSetEncoding(nvjpegEncoderParams_t encoder_params, nvjpegJpegEncoding_t etype, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetEncoding")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetEncoding")) :
                           nvjpegEncoderParamsSetEncodingNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsSetOptimizedHuffman(nvjpegEncoderParams_t encoder_params, const int optimized, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetOptimizedHuffman")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetOptimizedHuffman")) :
                           nvjpegEncoderParamsSetOptimizedHuffmanNotFound;
...
nvjpegStatus_t nvjpegEncoderParamsSetSamplingFactors(nvjpegEncoderParams_t encoder_params, const nvjpegChromaSubsampling_t chroma_subsampling, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetSamplingFactors")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncoderParamsSetSamplingFactors")) :
                           nvjpegEncoderParamsSetSamplingFactorsNotFound;
...
nvjpegStatus_t nvjpegEncodeYUV(nvjpegHandle_t handle, nvjpegEncoderState_t encoder_state, const nvjpegEncoderParams_t encoder_params, const nvjpegImage_t * source, nvjpegChromaSubsampling_t chroma_subsampling, int image_width, int image_height, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeYUV")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeYUV")) :
                           nvjpegEncodeYUVNotFound;
...
nvjpegStatus_t nvjpegEncodeImage(nvjpegHandle_t handle, nvjpegEncoderState_t encoder_state, const nvjpegEncoderParams_t encoder_params, const nvjpegImage_t * source, nvjpegInputFormat_t input_format, int image_width, int image_height, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeImage")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeImage")) :
                           nvjpegEncodeImageNotFound;
...
nvjpegStatus_t nvjpegEncodeRetrieveBitstream(nvjpegHandle_t handle, nvjpegEncoderState_t encoder_state, unsigned char * data, size_t * length, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeRetrieveBitstream")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegEncodeRetrieveBitstream")) :
                           nvjpegEncodeRetrieveBitstreamNotFound;
...
nvjpegStatus_t nvjpegBufferPinnedCreate(nvjpegHandle_t handle, nvjpegPinnedAllocator_t * pinned_allocator, nvjpegBufferPinned_t * buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedCreate")) :
                           nvjpegBufferPinnedCreateNotFound;
...
nvjpegStatus_t nvjpegBufferPinnedCreateV2(nvjpegHandle_t handle, nvjpegPinnedAllocatorV2_t * pinned_allocator, nvjpegBufferPinned_t * buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedCreateV2")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedCreateV2")) :
                           nvjpegBufferPinnedCreateV2NotFound;
  return func_ptr(handle, pinned_allocator, buffer);
}
...
nvjpegStatus_t nvjpegBufferPinnedResize(nvjpegBufferPinned_t buffer, size_t size, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedResize")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedResize")) :
                           nvjpegBufferPinnedResizeNotFound;
...
nvjpegStatus_t nvjpegBufferPinnedDestroy(nvjpegBufferPinned_t buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferPinnedDestroy")) :
                           nvjpegBufferPinnedDestroyNotFound;
...
nvjpegStatus_t nvjpegBufferDeviceCreate(nvjpegHandle_t handle, nvjpegDevAllocator_t * device_allocator, nvjpegBufferDevice_t * buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceCreate")) :
                           nvjpegBufferDeviceCreateNotFound;
...
nvjpegStatus_t nvjpegBufferDeviceCreateV2(nvjpegHandle_t handle, nvjpegDevAllocatorV2_t * device_allocator, nvjpegBufferDevice_t * buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceCreateV2")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceCreateV2")) :
                           nvjpegBufferDeviceCreateV2NotFound;
  return func_ptr(handle, device_allocator, buffer);
}
...
nvjpegStatus_t nvjpegBufferDeviceResize(nvjpegBufferDevice_t buffer, size_t size, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceResize")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceResize")) :
                           nvjpegBufferDeviceResizeNotFound;
  return func_ptr(buffer, size, stream);
}
...
nvjpegStatus_t nvjpegBufferDeviceDestroy(nvjpegBufferDevice_t buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegBufferDeviceDestroy")) :
                           nvjpegBufferDeviceDestroyNotFound;
  return func_ptr(buffer);
}
...
nvjpegStatus_t nvjpegStateAttachPinnedBuffer(nvjpegJpegState_t decoder_state, nvjpegBufferPinned_t pinned_buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegStateAttachPinnedBuffer")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegStateAttachPinnedBuffer")) :
                           nvjpegStateAttachPinnedBufferNotFound;
...
nvjpegStatus_t nvjpegStateAttachDeviceBuffer(nvjpegJpegState_t decoder_state, nvjpegBufferDevice_t device_buffer) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegStateAttachDeviceBuffer")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegStateAttachDeviceBuffer")) :
                           nvjpegStateAttachDeviceBufferNotFound;
...
nvjpegStatus_t nvjpegJpegStreamCreate(nvjpegHandle_t handle, nvjpegJpegStream_t * jpeg_stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamCreate")) :
                           nvjpegJpegStreamCreateNotFound;
...
nvjpegStatus_t nvjpegJpegStreamDestroy(nvjpegJpegStream_t jpeg_stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamDestroy")) :
                           nvjpegJpegStreamDestroyNotFound;
...
nvjpegStatus_t nvjpegJpegStreamParse(nvjpegHandle_t handle, const unsigned char * data, size_t length, int save_metadata, int save_stream, nvjpegJpegStream_t jpeg_stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamParse")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamParse")) :
                           nvjpegJpegStreamParseNotFound;
...
nvjpegStatus_t nvjpegJpegStreamParseHeader(nvjpegHandle_t handle, const unsigned char * data, size_t length, nvjpegJpegStream_t jpeg_stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamParseHeader")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamParseHeader")) :
                           nvjpegJpegStreamParseHeaderNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetJpegEncoding(nvjpegJpegStream_t jpeg_stream, nvjpegJpegEncoding_t * jpeg_encoding) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetJpegEncoding")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetJpegEncoding")) :
                           nvjpegJpegStreamGetJpegEncodingNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetFrameDimensions(nvjpegJpegStream_t jpeg_stream, unsigned int * width, unsigned int * height) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetFrameDimensions")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetFrameDimensions")) :
                           nvjpegJpegStreamGetFrameDimensionsNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetComponentsNum(nvjpegJpegStream_t jpeg_stream, unsigned int * components_num) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetComponentsNum")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetComponentsNum")) :
                           nvjpegJpegStreamGetComponentsNumNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetComponentDimensions(nvjpegJpegStream_t jpeg_stream, unsigned int component, unsigned int * width, unsigned int * height) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetComponentDimensions")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetComponentDimensions")) :
                           nvjpegJpegStreamGetComponentDimensionsNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetExifOrientation(nvjpegJpegStream_t jpeg_stream, nvjpegExifOrientation_t * orientation_flag) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetExifOrientation")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetExifOrientation")) :
                           nvjpegJpegStreamGetExifOrientationNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetSamplePrecision(nvjpegJpegStream_t jpeg_stream, unsigned int * precision) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetSamplePrecision")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetSamplePrecision")) :
                           nvjpegJpegStreamGetSamplePrecisionNotFound;
...
nvjpegStatus_t nvjpegJpegStreamGetChromaSubsampling(nvjpegJpegStream_t jpeg_stream, nvjpegChromaSubsampling_t * chroma_subsampling) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetChromaSubsampling")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegJpegStreamGetChromaSubsampling")) :
                           nvjpegJpegStreamGetChromaSubsamplingNotFound;
...
nvjpegStatus_t nvjpegDecodeParamsCreate(nvjpegHandle_t handle, nvjpegDecodeParams_t * decode_params) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsCreate")) :
                           nvjpegDecodeParamsCreateNotFound;
...
nvjpegStatus_t nvjpegDecodeParamsDestroy(nvjpegDecodeParams_t decode_params) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsDestroy")) :
                           nvjpegDecodeParamsDestroyNotFound;
...
nvjpegStatus_t nvjpegDecodeParamsSetOutputFormat(nvjpegDecodeParams_t decode_params, nvjpegOutputFormat_t output_format) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetOutputFormat")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetOutputFormat")) :
                           nvjpegDecodeParamsSetOutputFormatNotFound;
...
nvjpegStatus_t nvjpegDecodeParamsSetROI(nvjpegDecodeParams_t decode_params, int offset_x, int offset_y, int roi_width, int roi_height) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetROI")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetROI")) :
                           nvjpegDecodeParamsSetROINotFound;
...
nvjpegStatus_t nvjpegDecodeParamsSetAllowCMYK(nvjpegDecodeParams_t decode_params, int allow_cmyk) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetAllowCMYK")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetAllowCMYK")) :
                           nvjpegDecodeParamsSetAllowCMYKNotFound;
...
nvjpegStatus_t nvjpegDecodeParamsSetExifOrientation(nvjpegDecodeParams_t decode_params, nvjpegExifOrientation_t orientation) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetExifOrientation")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeParamsSetExifOrientation")) :
                           nvjpegDecodeParamsSetExifOrientationNotFound;
...
nvjpegStatus_t nvjpegDecoderCreate(nvjpegHandle_t nvjpeg_handle, nvjpegBackend_t implementation, nvjpegJpegDecoder_t * decoder_handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderCreate")) :
                           nvjpegDecoderCreateNotFound;
...
nvjpegStatus_t nvjpegDecoderDestroy(nvjpegJpegDecoder_t decoder_handle) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderDestroy")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderDestroy")) :
                           nvjpegDecoderDestroyNotFound;
...
nvjpegStatus_t nvjpegDecoderJpegSupported(nvjpegJpegDecoder_t decoder_handle, nvjpegJpegStream_t jpeg_stream, nvjpegDecodeParams_t decode_params, int * is_supported) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderJpegSupported")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderJpegSupported")) :
                           nvjpegDecoderJpegSupportedNotFound;
...
nvjpegStatus_t nvjpegDecodeBatchedSupported(nvjpegHandle_t handle, nvjpegJpegStream_t jpeg_stream, int * is_supported) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedSupported")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedSupported")) :
                           nvjpegDecodeBatchedSupportedNotFound;
...
nvjpegStatus_t nvjpegDecodeBatchedSupportedEx(nvjpegHandle_t handle, nvjpegJpegStream_t jpeg_stream, nvjpegDecodeParams_t decode_params, int * is_supported) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedSupportedEx")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedSupportedEx")) :
                           nvjpegDecodeBatchedSupportedExNotFound;
...
nvjpegStatus_t nvjpegDecoderStateCreate(nvjpegHandle_t nvjpeg_handle, nvjpegJpegDecoder_t decoder_handle, nvjpegJpegState_t * decoder_state) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderStateCreate")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecoderStateCreate")) :
                           nvjpegDecoderStateCreateNotFound;
...
nvjpegStatus_t nvjpegDecodeJpegHost(nvjpegHandle_t handle, nvjpegJpegDecoder_t decoder, nvjpegJpegState_t decoder_state, nvjpegDecodeParams_t decode_params, nvjpegJpegStream_t jpeg_stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegHost")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegHost")) :
                           nvjpegDecodeJpegHostNotFound;
...
nvjpegStatus_t nvjpegDecodeJpegTransferToDevice(nvjpegHandle_t handle, nvjpegJpegDecoder_t decoder, nvjpegJpegState_t decoder_state, nvjpegJpegStream_t jpeg_stream, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegTransferToDevice")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegTransferToDevice")) :
                           nvjpegDecodeJpegTransferToDeviceNotFound;
...
nvjpegStatus_t nvjpegDecodeJpegDevice(nvjpegHandle_t handle, nvjpegJpegDecoder_t decoder, nvjpegJpegState_t decoder_state, nvjpegImage_t * destination, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegDevice")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeJpegDevice")) :
                           nvjpegDecodeJpegDeviceNotFound;
...
nvjpegStatus_t nvjpegDecodeBatchedEx(nvjpegHandle_t handle, nvjpegJpegState_t jpeg_handle, const unsigned char *const * data, const size_t * lengths, nvjpegImage_t * destinations, nvjpegDecodeParams_t * decode_params, cudaStream_t stream) {
  ...
  static auto func_ptr = reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedEx")) ?
                           reinterpret_cast<FuncPtr>(LOAD_SYMBOL_FUNC("nvjpegDecodeBatchedEx")) :
                           nvjpegDecodeBatchedExNotFound;
